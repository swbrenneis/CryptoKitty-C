...
const ByteArray SHA384::DER(DERbytes, sizeof(DERbytes));
 ...
 */
SHA384::W SHA384::decompose(const ByteArray& chunks) const {
...
ByteArray SHA384::finalize(const ByteArray& in) const {
 ...
 */
const ByteArray& SHA384::getDER() const {
 ...
 */
ByteArray SHA384:: pad(const ByteArray& in) const {
