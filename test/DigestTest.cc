...
bool DigestTest::sha1Test() {

    CK::SHA1 sha1;

    std::cout << "Empty message test." << std::endl;
    std::string empty("da39a3ee5e6b4b0d3255bfef95601890afd80709");
    std::cout << "Expected " << empty << std::endl;
    std::string actual(sha1.digest().toHexString());
    ...
    std::string abc("a9993e364706816aba3e25717850c26c9cd0d89d");
    std::cout << "Expected " << abc << std::endl;
    sha1.update(coder::ByteArray("abc"));
    actual = sha1.digest().toHexString();
    std::cout << "Actual   " << actual << std::endl;
    if (actual != abc) {
    ...
    std::string padTest("84983e441c3bd26ebaae4aa1f95129e5e54670f1");
    std::cout << "Expected " << padTest << std::endl;
    sha1.update(coder::ByteArray("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq"));
    actual = sha1.digest().toHexString();
    std::cout << "Actual   " << actual << std::endl;
    if (actual != padTest) {
    ...
    std::string million("34aa973cd4c4daa4f61eeb2bdbad27316534016f");
...
bool DigestTest::sha256Test() {
    ...
    std::cout << "Expected " << empty << std::endl;
    std::string actual(sha256.digest().toHexString());
    std::cout << "Actual   " << actual << std::endl;
    if (actual != empty) {
        std::cout << "Empty message test failed." << std::endl;
        return false;
    ...
    std::cout << "Expected " << abc << std::endl;
    sha256.update(coder::ByteArray("abc"));
    actual = sha256.digest().toHexString();
    std::cout << "Actual   " << actual << std::endl;
    if (actual != abc) {
        std::cout << "'abc' test failed." << std::endl;
        return false;
    ...
    std::cout << "Expected " << padTest << std::endl;
    sha256.update(coder::ByteArray("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq"));
    actual = sha256.digest().toHexString();
    std::cout << "Actual   " << actual << std::endl;
    if (actual != padTest) {
        std::cout << "Padding test failed." << std::endl;
...
bool DigestTest::sha384Test() {
    ...
    std::cout << "Expected " << empty << std::endl;
    std::string actual(sha384.digest().toHexString());
    std::cout << "Actual   " << actual << std::endl;
    if (actual != empty) {
        std::cout << "Empty message test failed." << std::endl;
        return false;
    ...
    std::cout << "Expected " << abc << std::endl;
    sha384.update(coder::ByteArray("abc"));
    actual = sha384.digest().toHexString();
    std::cout << "Actual   " << actual << std::endl;
    if (actual != abc) {
        std::cout << "'abc' test failed." << std::endl;
        return false;
    ...
    std::cout << "Expected " << padTest << std::endl;
    sha384.update(coder::ByteArray("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"));
    actual = sha384.digest().toHexString();
    std::cout << "Actual   " << actual << std::endl;
    if (actual != padTest) {
        std::cout << "Padding test failed." << std::endl;
...
bool DigestTest::sha512Test() {
    ...
    std::cout << "Expected " << empty << std::endl;
    std::string actual(sha512.digest().toHexString());
    std::cout << "Actual   " << actual << std::endl;
    if (actual != empty) {
        std::cout << "Empty message test failed." << std::endl;
        return false;
    ...
    std::cout << "Expected " << abc << std::endl;
    sha512.update(coder::ByteArray("abc"));
    actual = sha512.digest().toHexString();
    std::cout << "Actual   " << actual << std::endl;
    if (actual != abc) {
        std::cout << "'abc' test failed." << std::endl;
        return false;
    ...
    std::cout << "Expected " << padTest << std::endl;
    sha512.update(coder::ByteArray("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"));
    actual = sha512.digest().toHexString();
    std::cout << "Actual   " << actual << std::endl;
    if (actual != padTest) {
        std::cout << "Padding test failed." << std::endl;
